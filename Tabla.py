...
def Tabla(n,h,d):
    ...
    df.to_excel('/media/daniel/00C240BEC240B9A4/Users/digin/Dropbox/Mi PC (DESKTOP-F432S4K)/Documents/Maestria/RMF_archivosexcel/ValorC'+str(h)+'.xlsx',index=False,header=False)
